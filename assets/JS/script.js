...
import {deleteProducts,updateProduct,saveProduct,getAllProducts,viewQuestionDelete} from "./Functions/methodsProducts.mjs";
...
export const viwNewProduct = (arr) => {
  ...
  tableBody.innerHTML += `<tr id="produto_${values.id}">
      ...
      <button id="${values.id}" class="btn-delete" onclick="viewQuestionDelete(${values.id})"><img src="assets/img/deleteProduct.svg"</button>
      </td>                              
  </tr>`                             
  })
}
window.viewQuestionDelete = viewQuestionDelete
